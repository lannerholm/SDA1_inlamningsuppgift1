...
multipleModel <- lm(median_home_value ~ crime_rate + before_1940_p + radial_access + NOx + dist_fenway_park, data = Boston_census_data)
...
par(mfrow = c(1, 2))
plot(Boston_census_data$before_1940_p, Boston_census_data$median_home_value)
plot(Boston_census_data$before_1940_p, Boston_census_data$median_home_value^2)
par(mfrow = c(1, 1))
...
```{r}
multipleModel2 <- lm(median_home_value ~ crime_rate + I(before_1940_p^2) + radial_access + NOx + dist_fenway_park, data = Boston_census_data)
