...
plot(crime_rate ~ radial_access, data = Boston_census_data)
```
:::
...
Vi ser på våran qqplot att den är hyfsat linjär, och ser bra ut mellan -1 och 1. Därefter blir den snabbt mycket sämre därefter.
